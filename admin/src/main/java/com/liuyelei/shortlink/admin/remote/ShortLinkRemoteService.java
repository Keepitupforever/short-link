...
import com.liuyelei.shortlink.admin.remote.dto.req.*;
import com.liuyelei.shortlink.admin.remote.dto.resp.*;
...
public interface ShortLinkRemoteService {
     ...
     * 删除短链接
     *
     * @param requestParam 删除短链接短链接请求参数
     */
     ...
     * 访问分组短链接指定时间内监控数据
     *
     * @param requestParam 访问分组短链接监控请求参数
     * @return 分组短链接监控信息
     */
