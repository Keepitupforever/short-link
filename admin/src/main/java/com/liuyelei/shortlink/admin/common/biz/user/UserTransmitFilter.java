package com.liuyelei.shortlink.admin.common.biz.user;
...
import static com.liuyelei.shortlink.admin.common.enums.UserErrorCodeEnum.USER_TOKEN_FAIL;
...
public class UserTransmitFilter implements Filter {
    ...
    private static final List<String> IGNORE_URI = Lists.newArrayList(
        ...
        "/api/short-link/admin/v1/user/login/user/has-username"
    );
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException{
        ...
        if (!IGNORE_URI.contains(requestURI)) {
            ...
            if (!(Objects.equals(requestURI, "/api/short-link/admin/v1/user/login/user") && Objects.equals(method, "POST"))){
